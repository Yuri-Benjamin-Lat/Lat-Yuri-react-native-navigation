...
export const styles = StyleSheet.create({
  ...
  receiptContainer: { borderWidth: 0.5, borderRadius: 8, padding: 12, margin: 4 },
  receiptRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingVertical: 6, borderBottomWidth: 0.3, borderColor: "#aaa" },
  itemIcon: { width: 24, height: 24, marginRight: 6, alignSelf: "center" },
  itemName: { flex: 2, fontSize: 16 },
  itemQty: { flex: 1, fontSize: 16, textAlign: "center" },
  itemTotal: { flex: 1, fontSize: 16, textAlign: "right" },
  receiptTotalRow: { flexDirection: "row", justifyContent: "space-between", paddingTop: 10, borderTopWidth: 0.5, borderColor: "#aaa" },
